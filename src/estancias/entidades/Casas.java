...
public class Casas {
    ...
    public Casas() {
        ...
        this.tiempoMinimo =null;
        this.tiempoMaximo =null;
        this.precioHabitacion =null;
        this.tipoVivienda =null;
    }

    public Casas(Integer id, String calle, Integer numero, String codigoPostal, String ciudad, String pais, String fechaDesde, String fechaHasta, Integer tiempoMinimo, Integer tiempoMaximo, Double precioHabitacion, String tipoVivienda) {
        this.id = id;
        this.calle = calle;
        this.numero = numero;
